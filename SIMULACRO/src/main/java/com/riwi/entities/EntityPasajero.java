...
public class EntityPasajero {
    ...
    public EntityPasajero(int idVuelo, String destino, Date apellido, String documentoIdentidad) {
    }
    ...
    public EntityPasajero(String nombre, String apellido, String documento_identidad) {
        this.nombre = nombre;
        this.apellido = apellido;
        this.documento_identidad = documento_identidad;
    }
