...
public class EntityReservacion {
    ...
    public EntityReservacion(Date fecha_reservacion, String asiento, int id_pasajero, int id_vuelo) {
    ...
    public EntityReservacion(int id_reservacion, Date fecha_reservacion, String asiento, int id_pasajero, int id_vuelo) {
